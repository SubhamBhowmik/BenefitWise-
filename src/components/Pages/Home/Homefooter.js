...
const Homefooter = () => {
  return (
    <>
      <div class="text-center text-lg-start  text-dark" style={{ background: "rgba(253, 150, 68, 0.18)", zIndex: "-1" }}>

        <div className='homefooter' class="text-center text-lg-start  text-dark" >
