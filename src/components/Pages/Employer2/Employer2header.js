...
const Employer2header = () => {
    return (
        <>
            <section id='em9'>
                <div class="pri-header em-bg2 ">
                    <div className='moha-wrap'>
                    ...
                    <div class="pri-header-wrapper --new--pad">
                        ...
                        <div class="pri-header-left" style={{ width: "50%" }}>
                            ...
                            <img src="./images/employer2/kylo1.svg" class="img-fluid" alt="Web Development" />
...
export default Employer2header